# Vagrant-IaC
This is a small project to practice automation using Vagrant (Based on a DevOps Bootcamp by Imran Teli). It involves setting up a CentOS Stream 9 virtual machine, automating the installation of essential tools (httpd, wget, unzip, git), deploying a sample website (Mini Finance template), and configuring a functional web server.
